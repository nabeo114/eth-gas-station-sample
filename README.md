...
3. Configure the `.env` file:
    ...
    **Note:**
    ...
    - The `INFURA_API_KEY` is required to connect to the **Polygon Amoy testnet** via Infura. You can obtain this by creating an account at [Infura](https://app.infura.io/).
